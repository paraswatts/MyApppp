...
class ASM_User_Fragment : BaseFragment() {
    ...
    fun gettingListOfUser() {
        dataAGM.clear()
        objUsefullData.showProgress("getting user ... ", "")
        val mCall = apiEndpointInterface!!.getAllUserOfGm(mParam2.toString(), Integer.parseInt(objSaveData.getString(ConstantValue.CLIENT_ID)))
