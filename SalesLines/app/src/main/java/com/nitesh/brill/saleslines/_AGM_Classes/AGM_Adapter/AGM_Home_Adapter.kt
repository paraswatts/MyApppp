package com.nitesh.brill.saleslines._AGM_Classes.AGM_Adapter
...
class AGM_Home_Adapter(activity: Activity, private val body: List<GM_AsmView>) : RecyclerView.Adapter<AGM_Home_Adapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup?, viewType: Int): AGM_Home_Adapter.ViewHolder? {
