...
class Update_Enquiry_Fragment : BaseFragment() {
    ...
    private var Interaction_On: String? = " -- Select --"
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        btn_SaleClouser.visibility = GONE
...
//                        var fragment = Manager_View_Home_Fragment.newInstance("", "" + objSaveData.getString(ConstantValue.USER_ID))
...
//                        fragmentTransaction.commit()
    ...
    private fun sendDataToServerForUpdate() {
        ...
        Log.d("URL", "===  sendDataToServerForUpdate ===" + paramObject.toString())
        val body = RequestBody.create(MediaType.parse("application/json; charset=utf-8"), paramObject.toString())
...
//    }
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String, param3: String?, param4: String): Update_Enquiry_Fragment {
            val fragment = Update_Enquiry_Fragment()
            val args = Bundle()
