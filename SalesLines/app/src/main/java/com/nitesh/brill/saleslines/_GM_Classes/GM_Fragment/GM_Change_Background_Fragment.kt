...
class GM_Change_Background_Fragment : BaseFragment() {
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
       ...
       // tv_Font.setText("Current Font :- " + objSaveData.getString("mFontNameGM"))
        //=========================\\
        tv_FirstTheme.setOnClickListener {
            objSaveData.save(ConstantValue.GmAppTheme,"0")
          //  GM_Home_Activity.THEME = ConstantValue.AppTheme_Blue
        ...
        tv_SecondTheme.setOnClickListener {
            ...
            objSaveData.save(ConstantValue.GmAppTheme,"1")

//GM_Home_Activity.THEME = ConstantValue.AppTheme_Purple
            //-------------------------\\
        ...
        tv_ThirdTheme.setOnClickListener {
            ...
            objSaveData.save(ConstantValue.GmAppTheme,"2")
...
//            Manager_Home_Activity.THEME = ConstantValue.AppTheme
        ...
        tv_Font.setOnClickListener {
            ...
            selector("Select Font", mArrayFontName) { dialogInterface, i ->
                ...
                objSaveData.save("mFontNameGM",mArrayFontName.get(i).toString())
                objSaveData.save("mFont", "" + i)
                objSaveData.save("mFontPathGM", "" + mArrayFontPath.get(i).toString())
                tv_Font.setText("Current Font :- " + objSaveData.getString("mFontNameGM"))
    ...
    private fun callHomeActivity() {
       //To change body of created functions use File | Settings | File Templates.
        ...
        val intent = Intent(activity, GM_Home_Activity::class.java)
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String): GM_Change_Background_Fragment {
            val fragment = GM_Change_Background_Fragment()
            val args = Bundle()
