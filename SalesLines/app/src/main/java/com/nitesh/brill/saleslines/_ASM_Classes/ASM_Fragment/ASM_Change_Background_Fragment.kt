...
class ASM_Change_Background_Fragment : BaseFragment() {
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
       ...
       // tv_Font.setText("Current Font :- " + objSaveData.getString("mFontNameASM"))


        //=========================\\
        tv_FirstTheme.setOnClickListener {
            objSaveData.save(ConstantValue.ASMAppTheme,"0")
          //  ASM_Home_Activity.THEME = ConstantValue.AppTheme_Blue
        ...
        tv_SecondTheme.setOnClickListener {
            objSaveData.save(ConstantValue.ASMAppTheme,"1")
           // ASM_Home_Activity.THEME = ConstantValue.AppTheme_Purple
            //-------------------------\\
        ...
        tv_ThirdTheme.setOnClickListener {
            objSaveData.save(ConstantValue.ASMAppTheme,"2")
         //   ASM_Home_Activity.THEME = ConstantValue.AppTheme
            //-------------------------\\
        ...
        tv_Font.setOnClickListener {
            ...
            selector("Select Font", mArrayFontName) { dialogInterface, i ->
                ...
                objSaveData.save("mFontNameASM",mArrayFontName.get(i).toString())
                objSaveData.save("mFont", "" + i)
                objSaveData.save("mFontPathASM", "" + mArrayFontPath.get(i).toString())
                tv_Font.setText("Current Font :- " + objSaveData.getString("mFontNameASM"))
    ...
    private fun callHomeActivity() {
        ...
        val intent = Intent(activity, ASM_Home_Activity::class.java)
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String): ASM_Change_Background_Fragment {
            val fragment = ASM_Change_Background_Fragment()
            val args = Bundle()
