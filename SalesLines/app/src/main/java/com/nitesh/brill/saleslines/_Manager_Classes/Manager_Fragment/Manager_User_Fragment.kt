...
import com.nitesh.brill.saleslines._Manager_Classes.Manager_Adapter.Manager_User_Adapter
...
class Manager_User_Fragment : BaseFragment() {

    // TODO: Rename and change types of parameters
    private var mParam1: String? = null
    private var mParam2: String? = null
    private var mAdapter: Manager_User_Adapter? = null
            ...
            override fun onResponse(call: Call<List<Manager_User_List>>?, response: Response<List<Manager_User_List>>?) {
                ...
                if (response.isSuccessful) {
                    ...
                    if (size > 0) {
                        ...
                        objUsefullData.showMsgOnUI("User not found")
                    }

                    mAdapter = Manager_User_Adapter(activity!!, dataUser)
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String): Manager_User_Fragment {
            val fragment = Manager_User_Fragment()
            val args = Bundle()
