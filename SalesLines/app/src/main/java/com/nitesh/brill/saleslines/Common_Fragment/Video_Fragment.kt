...
class Video_Fragment : BaseFragment() {
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        tv_video1.setOnClickListener {
            if (isNetworkConnected)
            loadCustomTabForSite("https://www.youtube.com/watch?v=efRNKkmWdc03")

        }

        tv_video2.setOnClickListener {
            if (isNetworkConnected)
            loadCustomTabForSite("https://www.youtube.com/watch?v=efRNKkmWdc03")

        }

        tv_video3.setOnClickListener {
            if (isNetworkConnected)
            loadCustomTabForSite("https://www.youtube.com/watch?v=efRNKkmWdc03")

        }

        tv_video4.setOnClickListener {
            if (isNetworkConnected)
            loadCustomTabForSite("https://www.youtube.com/watch?v=efRNKkmWdc03")
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String): Video_Fragment {
