...
class ASM_Change_Notification_Sound_Fragment : BaseFragment() {
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String): ASM_Change_Notification_Sound_Fragment {
            val fragment = ASM_Change_Notification_Sound_Fragment()
            val args = Bundle()
