...
import com.nitesh.brill.saleslines._Manager_Classes.Manager_Fragment.Manager_User_View_Fragment
import com.nitesh.brill.saleslines._Manager_Classes.Manager_PojoClass.Manager_User_List
import android.os.Bundle



class Manager_User_Adapter(activity: Activity, val userList: List<Manager_User_List>) : RecyclerView.Adapter<Manager_User_Adapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Manager_User_Adapter.ViewHolder {
        val v = LayoutInflater.from(parent.context).inflate(R.layout.adapter_gm_home, parent, false)
        return ViewHolder(v)
    }

    //this method is binding the data on the list
    override fun onBindViewHolder(holder: Manager_User_Adapter.ViewHolder, position: Int) {
