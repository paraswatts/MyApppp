package com.nitesh.brill.saleslines._AAGM_Classes.AAGM_Fragment
...
class AGM_All_Lead_Fragment : BaseFragment() {
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String): AGM_All_Lead_Fragment {
            val fragment = AGM_All_Lead_Fragment()
            val args = Bundle()
