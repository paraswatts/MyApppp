...
class ASM_Add_Enquiry_Fragment : BaseFragment() {
    val PHOTOCAM = 10
    val PHOTOGAL = 11
    val VC1CAM = 12
    val VC1GAL = 13
...
//        }
    ...
    private fun getAllUserUnderASM() {
...
//        }
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String): ASM_Add_Enquiry_Fragment {
            val fragment = ASM_Add_Enquiry_Fragment()
            val args = Bundle()
