...
class ASM_All_Lead_Fragment : BaseFragment() {
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String): ASM_All_Lead_Fragment {
            val fragment = ASM_All_Lead_Fragment()
            val args = Bundle()
