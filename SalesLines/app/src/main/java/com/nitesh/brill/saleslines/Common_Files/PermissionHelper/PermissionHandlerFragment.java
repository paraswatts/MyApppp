...
import static com.nitesh.brill.saleslines.Common_Files.PermissionHelper.Utils.convertListToArray;
 ...
 * This class is abstract so can not have instance
 */
public abstract class PermissionHandlerFragment extends Fragment implements FragmentCompat.OnRequestPermissionsResultCallback {
    ...
    public void openSettingsForPermission() {
        ...
        Toast.makeText(getActivity(), messageSwitcherForToast(), Toast.LENGTH_LONG).show();
    ...
    private String messageSwitcherForToast() {
        ...
        return customMessage == null ? MessageGenerator.makeToastDialogMessage
                (convertListToArray
                        (remainedPermissionsList), getActivity()) : customMessage;
    }
    ...
    private void checkPermissionStuff() {
        ...
        if (Build.VERSION.SDK_INT < 23 || updateAllPermissionStatusAndCheckIfNotGrantedOneIsExists()) {
            ...
            if (shouldShowRequestPermissionRationaleForAll()) {
                ...
                Toast.makeText(getActivity(), messageSwitcherForToast(),
    ...
    private void initialize(String[] permissions, @Nullable String message, boolean sticky,
        ...
        permissionStatus = getActivity().getSharedPreferences("permissionStatus",
