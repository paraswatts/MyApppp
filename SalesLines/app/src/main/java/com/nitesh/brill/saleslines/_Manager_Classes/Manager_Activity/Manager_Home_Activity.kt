package com.nitesh.brill.saleslines._Manager_Classes.Manager_Activity
...
class Manager_Home_Activity : BaseActivity(), NavigationView.OnNavigationItemSelectedListener, updateNotIcon ,UpdateProfilePicture{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        UsefullData.Log("UserRole in home" + objSaveData.getString("userRole"))
        ReminderAsyncTask(baseContext).execute();

        //com.nitesh.brill.saleslines.Camera.NotificationAsyncTask(baseContext).execute();
        val userRole = objSaveData.getString("userRole")


        //==================\\
        if (objSaveData.getString(ConstantValue.ManagerAppTheme).equals("ManagerAppTheme")) {
            // do notihing

        } else {
            when (objSaveData.getString(ConstantValue.ManagerAppTheme).toInt()) {
        ...
        registerReceiver(myReceiver, IntentFilter(MyFirebaseMessagingService.INTENT_FILTER_MANAGER));
...
//                .into(mHomeImage)
       ...
       // imageView.background = resources.getDrawable(R.drawable.ic_user)
        ...
        //=======================================\\
        val notificationFragment = intent.getStringExtra("managerNotificationFragment")
        ...
        if (notificationFragment != null) {
            Log.e("Nottification type", notificationFragment)
            if (notificationFragment.equals("managerMissedFollowups")) {
                val fragment = Manager_MissedFollowupReminder_Fragment.newInstance("", "" + objSaveData.getString(ConstantValue.USER_ID))
                val bundle = Bundle()
            ...
            if (notificationFragment.equals("saleClosureManagerReminder")) {
                val fragment = Manager_SaleSaleClosureReminder_Fragment.newInstance("", "" + objSaveData.getString(ConstantValue.USER_ID))
                val bundle = Bundle()
                bundle.putString("userName", intent.getStringExtra("userName"))
                bundle.putString("image",intent.getStringExtra("image"))
            ...
            if (notificationFragment.equals("targetManagerReminder")) {

                val fragment = Manager_TargetReminder_Fragment.newInstance("", "" + objSaveData.getString(ConstantValue.USER_ID))
                val bundle = Bundle()
                bundle.putString("userName", intent.getStringExtra("userName"))
            ...
            val fragment = Manager_View_Home_Fragment.newInstance("", "" + objSaveData.getString(ConstantValue.USER_ID))
            //==== Call Fragment  ====\\
...
//            imageView.setTag(target)
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        ...
        when (id) {
            R.id.nav_home -> fragment = Manager_View_Home_Fragment.newInstance("", "" + objSaveData.getString(ConstantValue.USER_ID))
            R.id.nav_lead -> fragment = Manager_Add_Enquiry_Fragment.newInstance("", "" + objSaveData.getString(ConstantValue.USER_ID))
            ...
            R.id.nav_setting -> {
                fragment = Manager_Setting_Fragment.newInstance("", "")
                title = "Settings"
            }
                ...
                try {
                    if (response.isSuccessful) {
                        ...
                        if (success.equals("1")) {
                            ...
                            val intent = Intent(this@Manager_Home_Activity, Login_Activity::class.java)
