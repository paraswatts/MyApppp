...
import com.nitesh.brill.saleslines._AGM_Classes.AGM_Fragment.ASM_Change_Background_Fragment
import com.nitesh.brill.saleslines._Manager_Classes.Manager_Fragment.Manager_About_Fragment
...
class ASM_Setting_Fragment : BaseFragment() {
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        tv_Change.setOnClickListener {
           mFragment = ASM_Change_Background_Fragment.newInstance("", "")
            callFragment(mFragment)
        }
        //==================\\
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String): ASM_Setting_Fragment {
            val fragment = ASM_Setting_Fragment()
            val args = Bundle()
