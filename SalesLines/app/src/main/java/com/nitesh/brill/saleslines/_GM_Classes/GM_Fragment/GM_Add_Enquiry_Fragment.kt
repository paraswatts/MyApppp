...
class GM_Add_Enquiry_Fragment : BaseFragment() {
    val PHOTOCAM = 10
    val PHOTOGAL = 11
    val VC1CAM = 12
    val VC1GAL = 13
    ...
    var mArrayNameSalesman: MutableList<String> = ArrayList()
    var mArrayUserIdSalesman: MutableList<String> = ArrayList()
...
//
//            if (isNetworkConnected){}
//                //mShowAlertDialogWithListviewAGM(sp_Assign_Employee, mArrayName as ArrayList<String>, "Assign Employee")
//        }

        sp_Assign_AGM.setCompoundDrawablesWithIntrinsicBounds( 0, 0, R.drawable.arrow_spinner, 0);
        sp_Assign_AGM.setOnClickListener {

            //=================================\\

            if (isNetworkConnected)
                mShowAlertDialogWithListviewAGM(sp_Assign_AGM, mArrayName as ArrayList<String>, "Assign AGM")
        }
...
//=======================================================\\
    ...
    private fun mShowAlertDialogWithListviewAGM(sp_Assign_Employee: EditText?, animals: ArrayList<String>, s: String) {
    ...
    private fun getAllUserUnderAGM(userId:String) {

        mArrayNameAGM.clear()
        mArrayUserIdAGM.clear()
    ...
    private fun getAllUserUnderGM() {

        mArrayName.clear()
        mArrayUserId.clear()
        objUsefullData.showProgress("Getting AGM...", "")
...
//        }
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String): GM_Add_Enquiry_Fragment {
            val fragment = GM_Add_Enquiry_Fragment()
            val args = Bundle()
