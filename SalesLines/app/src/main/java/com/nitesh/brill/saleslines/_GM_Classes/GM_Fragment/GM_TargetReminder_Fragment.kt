...
import kotlinx.android.synthetic.main.gm_target.*

class GM_TargetReminder_Fragment : BaseFragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?,
        ...
        return inflater!!.inflate(R.layout.gm_target, container, false)
    }
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        if (bundle != null) {
            ...
            tv_total_target_gm.text = totalTarget
            tv_achieved_target_gm.text = targetAchieved
...
//            iv_missed_reminders.setImageBitmap(myBitmap)
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String): GM_TargetReminder_Fragment {
            val fragment = GM_TargetReminder_Fragment()
            val args = Bundle()
