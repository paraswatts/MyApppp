...
class Manager_All_Lead_Fragment : BaseFragment() {
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        textView2.setText("Manager View")
        //=============================================\\
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String): Manager_All_Lead_Fragment {
            val fragment = Manager_All_Lead_Fragment()
            val args = Bundle()
