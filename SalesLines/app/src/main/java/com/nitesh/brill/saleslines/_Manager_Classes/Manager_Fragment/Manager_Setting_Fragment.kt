...
class Manager_Setting_Fragment : BaseFragment() {
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        tv_Change.setOnClickListener {
            mFragment = Manager_Change_Background_Fragment.newInstance("", "")
            callFragment(mFragment)
        }
        //==================\\
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String): Manager_Setting_Fragment {
            val fragment = Manager_Setting_Fragment()
            val args = Bundle()
