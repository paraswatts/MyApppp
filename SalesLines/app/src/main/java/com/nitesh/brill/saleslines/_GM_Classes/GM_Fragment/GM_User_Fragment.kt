...
class GM_User_Fragment : BaseFragment() {
...
//        val mCall = apiEndpointInterface!!.getAllUserOfGm(et_Search.text.toString(), Integer.parseInt(objSaveData.getString(ConstantValue.CLIENT_ID)))
...
//    }
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String): GM_User_Fragment {
            val fragment = GM_User_Fragment()
            val args = Bundle()
